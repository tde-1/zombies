...
contextBridge.exposeInMainWorld('enw', {
  ...
  // The boot screen's Retry after Steam was not up or not signed in.
  retryPlay: () => call('retryPlay'),
  // The "already running" toast's End game (only for a game this launcher started).
