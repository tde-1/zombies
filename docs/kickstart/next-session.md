...
| Archive run (2026-09-26, cloud) | 2,024 maps catalogued, 263 held, 70 fetched in the cloud (3 in the bucket), **1,449 queued** after callofdutyrepo finished (4,975 links; snapshot `archive/state/`). **Upload loop blocked on B's permission rule** `Bash(/home/user/zombies/archive/cloud_loop.sh)`. PC publish steps `archive.md` §16.1; browser checklist `archive/browser-queue-2026-09-26.md`; run `scan_maps.py --keep-existing` once for `corpus-ignore.json` |
