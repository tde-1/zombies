...
| | State | Pointer |
|---|---|---|
| **Launcher on the feed** | **0.2.28** (2026-09-23 17:05 UK, lane INT), client DLL **`fd3039d2`** (same binary as the box). First release with DP1 (`ENWZombies.exe`: Discord no longer says World at War). Before: 0.2.27 `04a3ad6d` | `launcher.md` release table |
