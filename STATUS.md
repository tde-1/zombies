...
| **Box DLL** | **`974c2e8d`** in all 9 copies (2026-09-23 13:48 UK; clean worktree `wt-coord2` at main `5696406`: C1, 17b, T1, G1, A1). Rollback `binkw32.rollback-10ba8544.dll`. **Boot not yet proven by an agent lease** (B was playing; a running game keeps its DLL). Host agent and site restarts wait for B's word. Chain: `b36fe140` → `f8a835bb` → `86f12b12` → `6fccc0e0` → `79d4317d` → `c0986e5e` → `f920bb39` (unrecorded, reverted) → `03b04bc3` → `6b1ccfc5` → `683a475c` → `134a9d0f` → `499b70c1` → `06a2e1bd` → `10ba8544` → `974c2e8d` | `dedi.md` §22.6–22.9 |
