...
export const ITEMS = [
  ...
  { id: 'r_multiGpu', section: 'graphics', label: 'Optimize for Dual Video Cards', kind: 'toggle', to: 'waw', dvar: 'r_multiGpu', def: '0', enw: '0',
    src: 'ui.ff options_graphics @MENU_OPTIMIZE_FOR_DUAL_VIDEO_CARDS: r_multiGpu; cfg configure.cfg r_multiGpu "0"',
    note: 'Off. On a single GPU it breaks skinned models and stutters.' },
